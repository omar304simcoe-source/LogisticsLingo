...
export default async function ProfilePage() {
  ...
  // 3. Get user profile from 'profiles' table to get subscription tier
  ...
  if (profileError) {
    // Optional: handle error or fallback subscription tier
  }
  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-500">Subscription Tier</label>
          <p className="text-lg text-gray-900 font-semibold">{profile?.subscription_tier ?? "free"}</p>
        </div>
